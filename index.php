                    ...
                    <div class="col-md-4 p-0">
                        <div class="auth-form-light text-left p-3">
                            <div class="brand-logo" align="center">
                                <img class="img-avatar  " src="assets/img/companyimages/logo.jpg" alt=""><br>
                                <h4 class="text-muted  mb-1">
                                    Welcome Administrator !
                                </h4>
                            </div>
                            <form role="form" id=""  method="post" enctype="multipart/form-data" class="formfull">  
                                <div class="form-group first">
                                    <input type="text" class="form-control form-control-md" name="username" id="exampleInputEmail1" placeholder="Username" required>
                                </div>
                                <div class="form-group last">
                                    <input type="password" name="password" class="form-control form-control-md" id="exampleInputPassword1" placeholder="Password" required>
                                </div>
                                <div class="mt-1">
                                    <button name="login" class="btn btn-block btn-info btn-md font-weight-medium auth-form-btn">SIGN IN</button>
                                </div>
